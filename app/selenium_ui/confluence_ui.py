...
"""
def test_1_selenium_insert_macro(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.insert_macro(confluence_webdriver, confluence_datasets)
